 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |   Esc  |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; {L2}| Enter  |
 * |--------+------+------+------+------+------| Hyper|           | Meh  |------+------+------+------+------+--------|
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, LSFT(KC_COMM),LSFT(KC_DOT),  KC_UNDS, KC_PLUS, KC_F12,
                KC_TRNS, KC_LCBR,      KC_RCBR,       KC_MINS, KC_EQL,  KC_TRNS,
       KC_TRNS, KC_TRNS, KC_QUOT,      LSFT(KC_QUOT), KC_GRV,  KC_BSLS, KC_TRNS,
                         KC_TRNS,      KC_TRNS,       KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
