 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |   Esc  |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |Es{L2}| BckSpc |
 * |--------+------+------+------+------+------| Hyper|           | Meh  |------+------+------+------+------+--------|
 * |  Shift |   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |    . |  ?/  |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Ctrl |      |      |      | LAlt |                                       | [L3] | RAlt |      |      |      |
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_RCTRL,      KC_TRNS, KC_TRNS, KC_TRNS, KC_LALT,
                                                    KC_HOME, KC_END,
                                                             KC_PGUP,
                                    GUI_T(KC_SPC), KC_RCTRL, KC_PGDN,
        // right hand
        KC_TRNS, KC_6, KC_7,     KC_8,    KC_9,    KC_0,              KC_TRNS,
        KC_INS,  KC_Y, KC_U,     KC_I,    KC_O,    KC_P,              KC_TRNS,
                 KC_H, KC_J,     KC_K,    KC_L,    LT(MDIA, KC_ESC),  KC_BSPC,
        KC_TRNS, KC_N, KC_M,     KC_COMM, KC_DOT,  KC_SLSH,           KC_TRNS,
                       MO(NMBR), KC_RALT, KC_TRNS, KC_TRNS,           KC_TRNS,
        KC_LEFT, KC_RIGHT,
        KC_UP,
        KC_DOWN, KC_RSHIFT, LT(SYMB, KC_ENT)
    ),
